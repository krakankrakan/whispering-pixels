...
# Build the attacker
clang++ -c attacker/Cuda.cpp -o build/Cuda.o -std=c++17 -I./include -g
clang++ -c attacker/Executor.cpp -o build/Executor.o -std=c++17 -I./include -g
clang++ build/Cuda.o build/Executor.o -o build/Executor -lcuda -lcudart -I./include -g
